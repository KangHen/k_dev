...
<head>
    ...
    <link href="<?= asset('asset/default/dist/css/bootstrap-multiselect.css') ?>" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="<?= asset('asset/bower_components/metisMenu/dist/metisMenu.min.css') ?>" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="<?= asset('asset/default/dist/css/timeline.css') ?>" rel="stylesheet">
    ...
    <!-- Sweet Alert -->
    <link href="<?= asset('asset/bower_components/sweetalert/sweetalert2.css') ?>" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?= asset('asset/bower_components/morrisjs/morris.css') ?>" rel="stylesheet">
...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"> <img src="<?= asset('image/logo-mini.png') ?>" alt=""></a> 
    ...
    <script src="<?= asset('asset/default/dist/js/bootstrap-multiselect.js') ?>"></script>
    <!-- Metis Menu Plugin JavaScript -->
    <script src="<?= asset('asset/bower_components/metisMenu/dist/metisMenu.min.js') ?>"></script>

    <!-- Morris Charts JavaScript -->
    <?php
        if(isset($moris) && $moris == true){
    ?>
    <script src="<?= asset('asset/bower_components/raphael/raphael-min.js') ?>"></script>
    <script src="<?= asset('asset/bower_components/morrisjs/morris.min.js') ?>"></script>
    <script src="<?= asset('asset/default/js/morris-data.js') ?>"></script>
    <?php } ?>
    ...
    <script src="<?= asset('asset/bower_components/sweetalert/sweetalert2.min.js') ?>"></script>
